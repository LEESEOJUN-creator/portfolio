    ...
    <section id="contact" className="py-36 px-5 sm:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="relative rounded-2xl border border-violet-500/15 p-10 sm:p-16 overflow-hidden max-w-3xl mx-auto"
          style={{
            background:
        ...
        >
          ...
          <div className="relative flex flex-col items-center text-center gap-8">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-white/45 text-sm sm:text-base leading-[2] break-keep max-w-sm mx-auto" style={{ wordBreak: "keep-all" }}>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                ...
                <span>seojun7988@naver.com</span>
